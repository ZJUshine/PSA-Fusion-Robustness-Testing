...
class Evaluator:
    ...
    def run_checkpoint_once(self, checkpoint_to_restore):
        ...
        predictions_base_dir = '/home/usslab/Documents3/xuancun/sensorfusion-magician/avod/avod/data/outputs/lidar_laser_creating_car/predictions'
        ...
        if validation:
            ...
            if self.full_model:
                ...
                if self.do_kitti_native_eval:
                    print("Converting detections to kitti format")
